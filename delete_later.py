...
from dbmodels import Robot, Team, Stat, Season, Base
...
def createDB()->None:
    ...
    engine = create_engine("postgresql://battlebots_user:dPXnx39QSLYTCVEJReQSt4B75BzctaDK@dpg-d2ubicvfte5s73b0tebg-a.oregon-postgres.render.com/battlebots")
    Base.metadata.clear()
